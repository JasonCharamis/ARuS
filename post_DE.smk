...
rule add_orthology:
     ...
     shell: """ perl scripts/add_orthology_to_modified_edgeR_DE_output2.pl  {input.annotated} {input.ortho_info} > {output.orthology} && perl scripts/schwartz_transform.pl {output.orthology} > {output.orthology_sorted} """
